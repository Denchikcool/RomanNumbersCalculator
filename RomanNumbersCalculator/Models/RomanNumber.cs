...
namespace RomanNumbersCalculator.Models
{
    internal class RomanNumber : IComparable, ICloneable
    {
        ...
        {
            if (number < 1 || number >= 4000) throw new RomanNumberException("#ERROR");
        ...
        public RomanNumber(string number)
        {
            ...
            if (this.number < 1 || this.number >= 4000) throw new RomanNumberException("#ERROR");
        }
        ...
        public int CompareTo(object? obj)
        {
            ...
            else throw new ArgumentException("Something wrong! Check your number.");
        }
